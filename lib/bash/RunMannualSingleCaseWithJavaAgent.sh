...
# 第7个参数$7表示  bf_type
# 第8个参数$8表示  single_test (pkg::casename)
...
defects4j test_diy -w $checkout_addr -o $ant_log_output -a $ant_build_file_addr -t $single_test
